...
// Patching MarkupView (if needed)
// TODO: Bug 1036949 - New API: MarkupView customization
let originalTemplate = MarkupView.prototype.template;

if (originalTemplate.toString().indexOf("markupview-render") < 0) {
...
function shutdown() {
  ...
  // TODO: iterate also all existing instances
  // and un-patch
}
